...
const INPUT_CLASS =
  "rounded-xl border border-zinc-200 bg-stone-50/80 px-4 py-3 text-sm text-zinc-900 placeholder:text-zinc-300 outline-none transition-colors focus:border-zinc-400 focus:bg-white"
